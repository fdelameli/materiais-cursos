...
public class FreeGraphEditor extends BasicGraphEditor
{
	...
	public FreeGraphEditor()
	{
		...
		shapesPalette.addListener(mxEvent.SELECT,
		...
		shapesPalette.addTemplate("Actor", new ImageIcon(FreeGraphEditor.class
				.getResource("/com/mxgraph/swing/examples/images/actor.png")),
				"shape=actor", 120, 160, "");
		shapesPalette.addTemplate("Cloud", new ImageIcon(FreeGraphEditor.class
		...
		imagesPalette.addTemplate("Bell", new ImageIcon(FreeGraphEditor.class
				.getResource("/com/mxgraph/swing/examples/images/bell.png")),
				"image;image=/com/mxgraph/swing/examples/images/bell.png", 50,
				50, "Bell");
		imagesPalette.addTemplate("Box", new ImageIcon(FreeGraphEditor.class
		...
		imagesPalette
				.addTemplate(
						...
						50, 50, "Earth");
		imagesPalette.addTemplate("Gear", new ImageIcon(FreeGraphEditor.class
				.getResource("/com/mxgraph/swing/examples/images/gear.png")),
				"roundImage;image=/com/mxgraph/swing/examples/images/gear.png",
				50, 50, "Gear");
		imagesPalette.addTemplate("Home", new ImageIcon(FreeGraphEditor.class
		...
		imagesPalette
				.addTemplate(
						...
						50, 50, "Printer");
		imagesPalette.addTemplate("Server", new ImageIcon(FreeGraphEditor.class
		...
		symbolsPalette
				.addTemplate(
						...
						80, 80, "Inclusive");
		symbolsPalette.addTemplate("Link", new ImageIcon(FreeGraphEditor.class
		...
		symbolsPalette
				.addTemplate(
						...
						80, 80, "Multiple");
		symbolsPalette.addTemplate("Rule", new ImageIcon(FreeGraphEditor.class
