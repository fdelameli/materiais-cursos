/**
 * $Id: mxGraphViewImageReader.java,v 1.4 2009/04/12 09:50:16 gaudenz Exp $
...
public class mxGraphViewImageReader extends mxGraphViewReader
{
	...
	public mxICanvas createCanvas(Hashtable attrs)
	{
		...
		mxImageCanvas canvas = new mxImageCanvas(new mxGraphics2DCanvas(),
				width, height, getBackground(), isAntiAlias());
