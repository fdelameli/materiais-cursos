/**
 * $Id: mxGraphViewReader.java,v 1.23 2009/04/02 21:56:27 gaudenz Exp $
...
public abstract class mxGraphViewReader extends DefaultHandler
{
	...
	public void drawLabel(boolean isEdge, Hashtable attrs)
	{
		...
		if (label != null && label.length() > 0)
		{
			...
			canvas.drawLabel(label, (int) Math.round(bounds.getX()), (int) Math
					.round(bounds.getY()), (int) Math.round(bounds.getWidth()),
					(int) Math.round(bounds.getHeight()), attrs, false);
		}
	}
