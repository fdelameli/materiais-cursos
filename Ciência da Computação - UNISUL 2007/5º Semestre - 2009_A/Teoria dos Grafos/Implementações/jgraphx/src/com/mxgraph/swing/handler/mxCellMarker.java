/**
 * $Id: mxCellMarker.java,v 1.10 2009/04/05 09:22:44 gaudenz Exp $
...
public class mxCellMarker extends JComponent
{
	...
	protected void mark()
	{
		if (markedState != null)
		{
			...
			repaint();
			eventSource.fireEvent(mxEvent.MARK, new mxEventObject(
					new Object[] { markedState }));
		}
	}
	...
	protected void unmark()
	{
		if (getParent() != null)
		{
			...
			eventSource.fireEvent(mxEvent.MARK);
		}
	}
