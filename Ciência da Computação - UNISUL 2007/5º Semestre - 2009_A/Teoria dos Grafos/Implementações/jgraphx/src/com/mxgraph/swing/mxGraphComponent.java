/**
 * $Id: mxGraphComponent.java,v 1.60 2009/04/11 22:49:39 gaudenz Exp $
...
public class mxGraphComponent extends JScrollPane implements Printable
{
	...
	protected mxIEventListener repaintHandler = new mxIEventListener()
	{
		...
		{
			mxRectangle dirty = (evt.getArgCount() > 0) ? (mxRectangle) evt
					.getArgAt(0) : null;
	...
	public class mxGraphControl extends JComponent
	{
		...
		{
			eventSource.fireEvent(mxEvent.BEFORE_PAINT, new mxEventObject(
					new Object[] { g }));
			super.paint(g);
			eventSource.fireEvent(mxEvent.AFTER_PAINT, new mxEventObject(
					new Object[] { g }));
		}
