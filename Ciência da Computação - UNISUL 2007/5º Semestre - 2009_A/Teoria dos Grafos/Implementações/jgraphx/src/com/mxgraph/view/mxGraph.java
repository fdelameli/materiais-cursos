/**
 * $Id: mxGraph.java,v 1.226 2009/04/11 10:12:17 gaudenz Exp $
...
public class mxGraph extends mxEventSource
{
	 ...
	 * is 0.99.0.4.
	 */
	public static final String VERSION = "0.99.0.4";
	...
	protected mxIEventListener graphModelChangeHandler = new mxIEventListener()
	{
		public void invoke(Object sender, mxEventObject evt)
		{
			mxRectangle dirty = graphModelChanged((mxIGraphModel) sender,
					(List) evt.getArgAt(0));
			fireEvent(mxEvent.REPAINT,
					new mxEventObject(new Object[] { dirty }));
		}
	};
	 ...
	 */
	public Object[] getSelectionCellsForChanges(List changes)
	{
	 ...
	 */
	public Object[] getRemovedCellsForChanges(List changes)
	{
	...
	public Object[] alignCells(String align, Object[] cells, Object param)
	{
		...
		if (cells != null && cells.length > 1)
		{
			...
			try
			{
				...
				fireEvent(mxEvent.ALIGN_CELLS, new mxEventObject(
						new Object[] { cells }));
			}
			finally
			{
	...
	public Object flipEdge(Object edge)
	{
		if (edge != null && alternateEdgeStyle != null)
		{
			...
			try
			{
				...
				resetEdge(edge);
				fireEvent(mxEvent.FLIP_EDGE, new mxEventObject(
						new Object[] { edge }));
			}
			finally
			{
	...
	public Object[] orderCells(boolean back, Object[] cells)
	{
		...
		try
		{
			...
			fireEvent(mxEvent.ORDER_CELLS, new mxEventObject(new Object[] {
					back, cells }));
		}
		finally
		{
	...
	public void cellsOrdered(Object[] cells, boolean back)
	{
		if (cells != null)
		{
			...
			try
			{
				...
				fireEvent(mxEvent.CELLS_ORDERED, new mxEventObject(
						new Object[] { cells, back }));
			}
			finally
			{
				model.endUpdate();
			...
			Object source, Object target)
	{
		...
		try
		{
			...
			fireEvent(mxEvent.ADD_CELLS, new mxEventObject(new Object[] {
	...
	public Object[] removeCells(Object[] cells, boolean includeEdges)
	{
		...
		{
			cellsRemoved(cells);
			fireEvent(mxEvent.REMOVE_CELLS, new mxEventObject(new Object[] {
					cells, includeEdges }));
		}
		finally
		{
	...
	public void cellsRemoved(Object[] cells)
	{
		if (cells != null && cells.length > 0)
		{
			...
			try
			{
				...
				fireEvent(mxEvent.CELLS_REMOVED, new mxEventObject(
						new Object[] { cells }));
			}
			finally
			{
			...
			double dx, double dy)
	{
		...
		try
		{
			...
			fireEvent(mxEvent.SPLIT_EDGE, new mxEventObject(new Object[] {
			...
			boolean includeEdges)
	{
		...
		try
		{
			...
			fireEvent(mxEvent.TOGGLE_CELLS, new mxEventObject(new Object[] {
					show, cells, includeEdges }));
		}
		finally
		{
			model.endUpdate();
	...
	public Object[] foldCells(boolean collapse, boolean recurse, Object[] cells)
	{
		...
		try
		{
			...
			fireEvent(mxEvent.FOLD_CELLS, new mxEventObject(new Object[] {
					collapse, recurse, cells }));
		}
		finally
		{
			model.endUpdate();
	...
	public void cellsFolded(Object[] cells, boolean collapse, boolean recurse)
	{
		if (cells != null && cells.length > 0)
		{
			...
			try
			{
				...
				fireEvent(mxEvent.CELLS_FOLDED, new mxEventObject(new Object[] {
						cells, collapse, recurse }));
			}
			finally
			{
				model.endUpdate();
	...
	{
		List allCells = new ArrayList(cells.length);
		...
		if (cell != null)
		{
			...
			try
			{
				...
				if (size != null && geo != null)
				{
					...
					{
						mxRectangle bounds = getCellBounds(cell, false, true);
	 ...
	 * @param boundsArray Array of rectangles that represents the new bounds.
	 */
	public Object[] resizeCells(Object[] cells, mxRectangle[] boundsArray)
	{
		model.beginUpdate();
		try
		{
			cellsResized(cells, boundsArray);
			fireEvent(mxEvent.RESIZE_CELLS, new mxEventObject(new Object[] {
					cells, boundsArray }));
		}
		finally
		{
	 ...
	 */
	public void cellsResized(Object[] cells, mxRectangle[] boundsArray)
	{
				...
				&& cells.length == boundsArray.length)
		{
			...
			try
			{
				for (int i = 0; i < cells.length; i++)
				{
					...
					if (geo != null
							&& (geo.getX() != bounds.getX()
									|| geo.getY() != bounds.getY()
									|| geo.getWidth() != bounds.getWidth() || geo
	...
	public Object connectCell(Object edge, Object terminal, boolean source)
	{
		...
		try
		{
			...
			fireEvent(mxEvent.CONNECT_CELL, new mxEventObject(new Object[] {
					edge, terminal, source }));
		}
		finally
		{
			model.endUpdate();
	...
	public void cellConnected(Object edge, Object terminal, boolean source)
	{
		if (edge != null)
		{
			...
			try
			{
				...
				fireEvent(mxEvent.CELL_CONNECTED, new mxEventObject(
						new Object[] { edge, terminal, source }));
			}
			finally
			{
				model.endUpdate();
	 ...
	 * @param newValue New label to be assigned.
	...
	/**
	 * @param constrainChildren the constrainChildren to set
	 */
			...
			Object parent)
	{
		...
		Collection cells = mxGraphModel.filterDescendants(getModel(),
