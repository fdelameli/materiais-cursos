...
/**
 * Classe responsável por exibir e imprimir as instruções geradas
 */
...
public class Instrucoes_Maquina extends JDialog {
	...
	public Instrucoes_Maquina(){
		setTitle( "Instruções passadas para a Máquina Hipotética" );
	...
	public void inicio(){
		...
		modTab.setColumnIdentifiers(new String[]{"Instrução","Op1","Op2"});
