...
//		toolBar.setBounds(new Rectangle(1, 1, Display.getCurrent().getBounds().width-2, 42));
...
//				createFrmDespesa();
	...
	private void createFrmCliente(){
		if(cTabItemCliente == null ||cTabItemCliente.isDisposed()){
			...
			msg.setMessage("O cadastro de clientes já está aberto.");
			msg.setText("Atenção!");
			msg.open();
		}
	}
...
//		} else {
//			MessageBox msg = new MessageBox(sShell, SWT.ICON_WARNING | SWT.OK);
//			msg.setMessage("O cadastro de despesas já está aberto.");
//			msg.setText("Atenção!");
//			msg.open();
//		}
//	}
