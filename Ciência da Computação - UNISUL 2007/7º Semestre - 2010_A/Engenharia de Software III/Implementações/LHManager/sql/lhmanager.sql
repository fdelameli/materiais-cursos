...
insert  into `despesa`(`cd_des`,`ds_des`,`vl_des`,`dt_pagto`,`tp_des`) values (3,'Conta da janela nova quebrada por vândalos.',50,'2010-06-23',2),(4,'Novas placas de vídeo para os computadores.',5492.56,'2010-06-17',1),(5,'Conta de energia.',197.45,'2010-06-25',3),(6,'Cinco novas cadeiras.',857.5,'2010-05-03',3),(7,'Despesa com a porta arrombada!',130.22,'2010-06-21',2);
