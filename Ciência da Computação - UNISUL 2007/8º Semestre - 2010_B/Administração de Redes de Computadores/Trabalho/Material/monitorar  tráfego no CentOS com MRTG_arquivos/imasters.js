...
var s_account=uol_sco.s_account||"uolimasters"
...
/* Character Config*/
uol_sc.charSet="iso-8859-1";
/* Link Tracking Config */
uol_sc.trackDownloadLinks=true
uol_sc.trackExternalLinks=true
uol_sc.trackInlineStats=true
uol_sc.linkDownloadFileTypes="exe,zip,rar,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx,iso"
uol_sc.linkInternalFilters=uol_sco.linkInternalFilters||"javascript:,imasters.uol.com.br,imasters.com.br,mercado.imasters.uol.com.br,multimidia.imasters.uol.com.br,blog.imasters.uol.com.br,mailto:,clicklogger.rm.uol.com.br,/bn.uol.com.br,/bn.i.uol.com.br,/clicklog-af.shopping.uol.com.br,/click.bol.com.br,/de.uol.com.br"
...
oOmnitureChannel={};oOmnitureChannel.sName = "Tecnologia-parceiros-imasters"

/* APPENDIX */
/* SEARCH */
function convertOmnitureParams(){
	if( typeof omnitureParams != "undefined"){
		if(omnitureParams.searchTerm && omnitureParams.searchTerm!=""){
			uol_sc.prop12= omnitureParams.searchTerm.toLowerCase();
			uol_sc.eVar12=uol_sc.prop12;
			if(omnitureParams.searchType && omnitureParams.searchType!="") {
				uol_sc.prop44= omnitureParams.searchType.toLowerCase();
			}
