...
void main() {
   ...
   while(true) {
      ...
      */
      ...
      printf("%S\r\n", s);
      strncpy(outro, s, 6)/ // copia uma string até a 6ª posicao para um vetor de caracteres
      printf("%S\r\n", outro);
      // compara duas strings 
      // se as strings forem iguais retorna 0 | Se for maior retorna numero positivo | Senão retorna numero negativo
      n = strcmp(s,outro);
      if(n == 0) {
         printf("Iguais\r\n");
      } else if (n > 0) {
      ...
      */
      ...
      /*
      if(isalnum(c)){ // verifica se uma string é numérica
      ...
      */
      /*
      if(isalpha(c)){ // verifica se uma string é alfanumérica
      ...
      */
      /*
      if(islower(c)){ // verifica se é minusculo
         printf("Minusculo\r\n"); 
      } else {
         printf("Mauisculo\r\n");
      }
      ...
      */
      /*
      if(isamoung(c, "*-pos%12)")){ // verifica se um contém um caracter dentro da String passada
         printf("Contem\r\n"); 
      } else {
         printf("Nao contem\r\n");
      }
