...
;*									*
;*	 	      DEMONSTRAR A UTILIZAÇÃO DO LCD			*
;*									*
;*	*	*	*	*	*	*	*	*	*
...
ATUALIZA_TELA
	...
	MOVLW	0x01
	CALL	ENVIA_COMANDO	; COMANDO PARA LIMPAR A TELA
	...
	MOVF	TEMP,W		; ENVIA O CARACTER DA 
	CALL	ENVIA_DADO	; TECLA CORRESPONDENTE
...
LOOP
	...
	MOVLW	'0'		; MOVE CARACTER ASCII DA TECLA PARA W
	BTFSC	TECLA_0		; A TECLA ESTÁ PRESSIONADA?
	CALL	ATUALIZA_TELA	; SIM, ENTÃO CHAMA A ROTINA DE ATUALIZAÇÃO
	
	MOVLW	'1'		; MOVE CARACTER ASCII DA TECLA PARA W
	BTFSC	TECLA_1		; A TECLA ESTÁ PRESSIONADA?
	CALL	ATUALIZA_TELA	; SIM, ENTÃO CHAMA A ROTINA DE ATUALIZAÇÃO
	
	MOVLW	'2'		; MOVE CARACTER ASCII DA TECLA PARA W
	BTFSC	TECLA_2		; A TECLA ESTÁ PRESSIONADA?
	CALL	ATUALIZA_TELA	; SIM, ENTÃO CHAMA A ROTINA DE ATUALIZAÇÃO
	
	MOVLW	'3'		; MOVE CARACTER ASCII DA TECLA PARA W
	BTFSC	TECLA_3		; A TECLA ESTÁ PRESSIONADA?
	CALL	ATUALIZA_TELA	; SIM, ENTÃO CHAMA A ROTINA DE ATUALIZAÇÃO
	
	MOVLW	'4'		; MOVE CARACTER ASCII DA TECLA PARA W
	BTFSC	TECLA_4		; A TECLA ESTÁ PRESSIONADA?
	CALL	ATUALIZA_TELA	; SIM, ENTÃO CHAMA A ROTINA DE ATUALIZAÇÃO
	
	MOVLW	'5'		; MOVE CARACTER ASCII DA TECLA PARA W
	BTFSC	TECLA_5		; A TECLA ESTÁ PRESSIONADA?
	CALL	ATUALIZA_TELA	; SIM, ENTÃO CHAMA A ROTINA DE ATUALIZAÇÃO
	
	MOVLW	'6'		; MOVE CARACTER ASCII DA TECLA PARA W
	BTFSC	TECLA_6		; A TECLA ESTÁ PRESSIONADA?
	CALL	ATUALIZA_TELA	; SIM, ENTÃO CHAMA A ROTINA DE ATUALIZAÇÃO
	
	MOVLW	'7'		; MOVE CARACTER ASCII DA TECLA PARA W
	BTFSC	TECLA_7		; A TECLA ESTÁ PRESSIONADA?
	CALL	ATUALIZA_TELA	; SIM, ENTÃO CHAMA A ROTINA DE ATUALIZAÇÃO
	
	MOVLW	'8'		; MOVE CARACTER ASCII DA TECLA PARA W
	BTFSC	TECLA_8		; A TECLA ESTÁ PRESSIONADA?
	CALL	ATUALIZA_TELA	; SIM, ENTÃO CHAMA A ROTINA DE ATUALIZAÇÃO
	
	MOVLW	'9'		; MOVE CARACTER ASCII DA TECLA PARA W
	BTFSC	TECLA_9		; A TECLA ESTÁ PRESSIONADA?
	CALL	ATUALIZA_TELA	; SIM, ENTÃO CHAMA A ROTINA DE ATUALIZAÇÃO
	
	MOVLW	'C'		; MOVE CARACTER ASCII DA TECLA PARA W
	BTFSC	TECLA_C		; A TECLA ESTÁ PRESSIONADA?
	CALL	ATUALIZA_TELA	; SIM, ENTÃO CHAMA A ROTINA DE ATUALIZAÇÃO
	
	MOVLW	'E'		; MOVE CARACTER ASCII DA TECLA PARA W
