...
;* 	    EXEMPLO8: UTILIZAÇÃO DA MEMÓRIA DE PROGRAMA DO PIC		*
...
#DEFINE ENDERECO_FLASH	0x800	; ENDEREÇO PARA ARMAZENAR O BUFFER DO SISTEMA
...
;*	*	*	*	*	*	*	*	*	*
	...
	ORG 	0x800
	DB	0,'A',0,'p',0,'i',0,'c',0,'e',0,' '
	DB	0,'T',0,'e',0,'c',0,'n',0,'o',0,'l',0,'o',0,'g',0,'i',0,'.'
...
GUARDA_BUFFER
	...
	MOVLW	HIGH(ENDERECO_FLASH) ; CARREGA O ENDEREÇO DA FLASH	
	MOVWF	ENDERECO_HI	     ; PARA SALVAR O DADO	
	MOVLW	LOW(ENDERECO_FLASH)
	MOVWF	ENDERECO_LO
	
	MOVLW	BUFFER0		; MOVE O PONTEIRO PARA SALVAR O CONTEÚDO	
	CALL	ESCREVE_FLASH	; DE BYTES
	
	MOVLW	BUFFER4		; MOVE O PONTEIRO PARA SALVAR O CONTEÚDO		
	CALL	ESCREVE_FLASH   ; DE BYTES
	
	MOVLW	BUFFER8		; MOVE O PONTEIRO PARA SALVAR O CONTEÚDO	
	CALL	ESCREVE_FLASH	; DE BYTES
	
	MOVLW	BUFFER12	; MOVE O PONTEIRO PARA SALVAR O CONTEÚDO	
	CALL	ESCREVE_FLASH	; DE BYTES
...
LE_DADOS
	...
	MOVLW	HIGH(ENDERECO_FLASH) ; CARREGA ENDEREÇO DA FLASH	
	MOVWF	ENDERECO_HI
	MOVLW	LOW(ENDERECO_FLASH)
	MOVWF	ENDERECO_LO
...
LE_DADOS_A
	...
	CALL	LE_FLASH	; CHAMA ROTINA PARA LER A EEPROM	
...
LE_FLASH
	...
	BANKSEL EECON1
	BSF	EECON1,EEPGD		; APONTA PARA MEMÓRIA EEPROM
...
ESCREVE_FLASH_A
	...
	MOVLW	.4
	ADDWF	ENDERECO_LO,F		; PREPARA PARA LER O PRÓXIMO BLOCO
	BTFSC	STATUS,C
	INCF	ENDERECO_HI	
...
LOOP
	...
	CALL	GUARDA_BUFFER	; CHAMA ROTINA PARA SALVAR O BUFFER
