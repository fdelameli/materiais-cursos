...
$002B	$0008			RETURN
$002C	$	_main:
;memoriaeeprom.c,33 :: 		void main(void)
;memoriaeeprom.c,35 :: 		portb=0;
$002C	$1303			BCF	STATUS, RP1
$002D	$1283			BCF	STATUS, RP0
$002E	$0186			CLRF	PORTB, 1
;memoriaeeprom.c,36 :: 		trisb=0b00000000;            //inicializa o barramento
$002F	$1683			BSF	STATUS, RP0
$0030	$0186			CLRF	TRISB, 1
;memoriaeeprom.c,37 :: 		trisd=0b00000000;            //configura i/o do sistema
$0031	$0188			CLRF	TRISD, 1
;memoriaeeprom.c,38 :: 		adcon1=7;                    //desliga a/d
$0032	$3007			MOVLW	7
$0033	$009F			MOVWF	ADCON1
;memoriaeeprom.c,39 :: 		option_reg=0b10000000;       //configura prescaler do timer 0
$0034	$3080			MOVLW	128
$0035	$0081			MOVWF	OPTION_REG
;memoriaeeprom.c,40 :: 		dado=eeprom_read(0);         //lê a posição zero de memória e carrega no barramento
...
;memoriaeeprom.c,42 :: 		while (1)
$003C	$	L_main_0:
;memoriaeeprom.c,45 :: 		portb.f5=1;                //liga a saída de leds
$003C	$1303			BCF	STATUS, RP1
$003D	$1283			BCF	STATUS, RP0
$003E	$1686			BSF	PORTB, 5
;memoriaeeprom.c,46 :: 		portd=dado;               //atualiza a saída de leds
$003F	$0820			MOVF	_dado, 0
$0040	$0088			MOVWF	PORTD
;memoriaeeprom.c,47 :: 		delay_ms(500);             //aguarda 1000ms
$0041	$3003			MOVLW	3
...
$005E	$285D			GOTO	$-1
$005F	$0000			NOP
;memoriaeeprom.c,49 :: 		portb.f5=0;                //desliga saída de leds
$0060	$1286			BCF	PORTB, 5
;memoriaeeprom.c,50 :: 		portd=0b11111110;          //seleciona linha 1 do teclado matricial
$0061	$30FE			MOVLW	254
$0062	$0088			MOVWF	PORTD
;memoriaeeprom.c,51 :: 		delay_us(10);              //tempo de acomodação
$0063	$3003			MOVLW	3
$0064	$00FA			MOVWF	STACK_10
$0065	$0BFA			DECFSZ	STACK_10, F
$0066	$2865			GOTO	$-1
;memoriaeeprom.c,53 :: 		if (porta.f4==0)           //se o botão estiver pressioando...
$0067	$3000			MOVLW	0
...
;memoriaeeprom.c,55 :: 		dado++;                //incrementa o dado
$006F	$0AA0			INCF	_dado, 1
;memoriaeeprom.c,56 :: 		eeprom_write(0,dado);  //atualiza a eeprom
...
;memoriaeeprom.c,57 :: 		}
$0074	$	L_main_2:
;memoriaeeprom.c,59 :: 		if (porta.f5==0)          //se o botão estiver pressioando...
$0074	$3000			MOVLW	0
...
;memoriaeeprom.c,61 :: 		dado--;                //decrementa o dado
$007E	$03A0			DECF	_dado, 1
;memoriaeeprom.c,62 :: 		eeprom_write(0,dado);  //atualiza a eeprom
