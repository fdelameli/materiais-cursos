...
public class MainGUI {
	...
	/**
	 * Liga determinado exaustor de acordo com a escolha do usuário.
	 * @param op Opção que determina qual exaustor será ligado.
	 */
	...
	/**
	 * Desliga determinado exaustor de acordo com a escolha do usuário.
	 * @param op Opção que determina qual exaustor será desligado.
	 */
	...
	/**
	 * Este método envia uma string para a porta serial.
	 */
	...
	/**
	 * Este método lê uma string da porta serial.
	 */
					...
					if ( !sShell.isDisposed() && !sShell.getDisplay().isDisposed() ) {
						sShell.getDisplay().asyncExec( new Runnable() {
							...
							public void run() {
								...
								if (v.length == 8) {
									labelSensorTemp1.setText( String.format( "%s ºC", v[ 0 ] ) );
									labelSensorTemp2.setText( String.format( "%s ºC", v[ 1 ] ) );
									labelSensorTemp3.setText( String.format( "%s ºC", v[ 2 ] ) );
									labelSensorTemp4.setText( String.format( "%s ºC", v[ 3 ] ) );
