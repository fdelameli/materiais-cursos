 ...
 * Função: Este arquivo contem um conjunto de constantes que são usadas  *
 *          para acesso ao controlador ethernet da Crystal CS8900A, ele  *
 *          é baseado no cabeçalho linux de Russel Nelso.                *
\*************************************************************************/

#define PP_ChipID            0x0000     // offset 0h -> Corp-ID
                                        // offset 2h -> Model/Product Num
                                        // offset 3h -> Chip Revision Num
...
//Primary I/O Base Address. If no I/O base is supplied by the user, then
// this can be used as the default I/O base to access the PacketPage Area.
#define DEFAULTIOBASE        0x0300

//PP_RxCFG - Receive Configuration and Interrupt Mask bit definition - R/W
...
// PP_TxCFG - Transmit Configuration Interrupt Mask bit definition - R/W
...
// PP_BufCFG - Buffer Configuration Interrupt Mask bit definition - R/W
