...
#else
	#warning Specialized delay routines not active - change #define PIC_CLK - (this is not a critical error)
#endif
...
//delay routine
	...
	#define Jumpback asm("goto $ - 6")
#else
	#warning DelayUs(N) routine not active - change #define PIC_CLK - (this is not a critical error)
#endif
