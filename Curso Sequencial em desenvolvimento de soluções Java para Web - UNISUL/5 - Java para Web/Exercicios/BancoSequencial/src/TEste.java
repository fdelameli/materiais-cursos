...
public class TEste extends JFrame
{
	...
	private String[] alfabeto = {"a", "b"};
	private String[] estados = {"q0", "q1", "q2"};
	private String[] estadosReconhecedores = {};
	private String[][] matrizTransicao = new String[2][3];
	...
	private void inicializaAutomato()
	{
		...
		matrizTransicao[0][0] = "q1";  //<q0> ::= a<q1>
		matrizTransicao[0][1] = "q1";  //<q1> ::= a<q1>
		matrizTransicao[1][1] = "q1";  //<q1> ::= b<q1>
	}
